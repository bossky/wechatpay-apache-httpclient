...
public class WechatPayV3RefundService extends WechatPayV3Service {
	 ...
	 * @throws WechatApiException 微信API异常
	 */
	public RefundQueryResponse query(String subMchid, String outRefundNo) throws IOException, WechatApiException {
		return exe(REFUND_PATH + "refunds/" + outRefundNo + "?sub_mchid=" + subMchid, null, RefundQueryResponse.class);
	}
