...
public class WechatPayV3NormalService extends WechatPayV3Service {
	...
	public NormalQueryResponse queryByTradeNo(String outTradeNo) throws IOException, WechatApiException {
		return exe(TRANSACTIONS_PATH + "out-trade-no/" + outTradeNo + "?mchid=" + merchantId, null,
				NormalQueryResponse.class);
	}
	 ...
	 */
	public NormalQueryResponse payNotification(String wechatPaySerial, String nonce, String timestamp, String signature,
			String body) throws ValidationException, ParseException {
