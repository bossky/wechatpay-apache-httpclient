...
public class WechatPayV3Service extends WechatPayService {
		...
		if (null == verifier) {
			...
			try {
				certificatesManager.putMerchant(merchantId,
						new WechatPay2Credentials(getMerchantId(),
								new PrivateKeySigner(getMerchantSerialNumber(), getPrivateKeyObject())),
	...
	protected HttpClientBuilder createBuilder() {
		return WechatPayHttpClientBuilder.create()
				.withMerchant(getMerchantId(), getMerchantSerialNumber(), getPrivateKeyObject())
	 ...
	 */
	public <E> E parse(String wechatPaySerial, String nonce, String timestamp, String signature, String body,
			Class<E> clazz) throws ValidationException, ParseException {
	 ...
	 * @throws ParseException      解析错误
	 */
	public Notification parse(String wechatPaySerial, String nonce, String timestamp, String signature, String body)
