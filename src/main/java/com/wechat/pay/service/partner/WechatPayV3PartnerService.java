...
public class WechatPayV3PartnerService extends WechatPayV3Service {
	 ...
	 * @throws WechatApiException 微信API异常
	 */
	public PartnerQueryResponse queryById(String subMchid, String transactionId)
			throws IOException, WechatApiException {
		return exe(TRANSACTIONS_PATH + "id/" + transactionId + "?sp_mchid=" + merchantId + "&sub_mchid=" + subMchid,
				null, PartnerQueryResponse.class);
	}
	 ...
	 * @throws WechatApiException 微信API异常
	 */
	public PartnerQueryResponse queryByTradeNo(String subMchid, String outTradeNo)
			throws IOException, WechatApiException {
		return exe(
				TRANSACTIONS_PATH + "out-trade-no/" + outTradeNo + "?sp_mchid=" + merchantId + "&sub_mchid=" + subMchid,
				null, PartnerQueryResponse.class);
	}
	 ...
	 */
	public PartnerQueryResponse payNotification(String wechatPaySerial, String nonce, String timestamp,
